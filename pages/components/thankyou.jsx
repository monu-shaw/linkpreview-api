...
export function Thankyou(){
  return (
        ...
        <ul>
          ...
          <li>Web Scraping with Axios and Cherio <a href="https://dev.to/drsimplegraffiti/i-scraped-dev-to-using-axios-and-cheerio-26ko" target="_blank" rel="noreferrer">Abayomi Ogunnusi(Dev.to)</a></li>
